...
public sealed partial class EliteRCDDeconstructableComponent : Component
{
    /// <summary>
    ...
    /// <summary>
    /// Toggles whether this entity is deconstructable by an Elite RCD or not
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public bool EliteRCDDeconstructable = true;
}
